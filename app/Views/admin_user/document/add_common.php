      ...
      <div class="container-fluid">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <h1 class="m-0">Comman Document</h1>
...
<div class="row mb-2">
  ...
  <div class="col-md-9">
    ...
    <form method="post" id="add_create" name="add_create" action="<?= base_url('/DashboardController/common_upload') ?>" enctype="multipart/form-data">

          <!-- <div class="form-group">

                <label for="formGroupExampleInput">Comman Document</label>
...
<script>
     ...
     $('#add').click(function(){  
                   i++;  
                   $('#dynamic_field').append('<tr id="row_nit'+i+'" class="dynamic-added"><td><h6>Document Type</h6><select id="Select1" name="workitem_name[]" class="Modified-Select" ><option value="Common Document">Common Document</option><option value="Technical">Technical </option><option value="Financial">Financial </option><option value="One time Document">One time Document</option></select></td><td><h6>Documents Name</h6><input autocomplete="off" class="form-control Modified-file" type="text" name="workitem_description[]" required></td><td><h6>Documents</h6><input autocomplete="off" class="form-control Modified-file" type="file" name="document_file[]" required></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></td></tr>');  
              });
