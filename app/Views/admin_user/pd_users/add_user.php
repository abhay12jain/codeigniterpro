...
<div class="row mb-2">
  ...
  <div class="col-md-9">
    ...
    <form  action="<?php echo base_url('AdminUserlist/store');?>" method="post" id="user_form" autocomplete="off">
...
<?//php } ?>
        ...
        <ul>
          <div class="drop_name">
            ...
            <?php  foreach($circle as $cirdata){
            if(!empty($cirdata['circle'])){?>
            <li><input type="checkbox" class="checkorg" value="<?php echo $cirdata['circle']; ?>" name="org_circle[]"> <label><?php echo $cirdata['circle']; ?></label></li>
          <?php }}?>
            </div>
        </ul>
    </div>
           ...
           <div class="drop_name">
            <li><input type="checkbox" value="all" class="checkorg" id="checkAll"> <label>Select All</label></li>
             <?php  foreach($organization_data as $organization){
                 if(!empty($organization['company_name'])){
              ?>
            <li><input type="checkbox" class="checkorg" value="<?php echo $organization['company_name']; ?>" name="org_organization[]"> <label><?php echo $organization['company_name']; ?></label></li>
          <?php }}?>
          </div>
...
<div class="check-list">
     ...
     <ul>
      <div class="drop_name">
        <li><input type="checkbox" value="all" class="checkorg" id="checkAll2"> <label>Select All</label></li>
            <li><input type="checkbox" class="checkorg" value="admin" name="role[]">
            <label class="">Admin</label></li>

            <li><input type="checkbox" class="checkorg" value="tender_creater" name="role[]">
            <label class="" >Tender Creater</label></li>

            <li><input type="checkbox" class="checkorg" value="tender_approver" name="role[]">
            <label class="" >Tender Approver</label></li>

            <li><input type="checkbox" class="checkorg" value="price_maker" name="role[]">
            <label class="" >Price Maker</label></li>

            <li><input type="checkbox" class="checkorg" value="price_checker" name="role[]">
            <label class="" >Price Checker</label></li>

            <li><input type="checkbox" class="checkorg" value="Technical" name="role[]">
            <label class="">Technical</label></li>

            <li><input type="checkbox" class="checkorg" value="Financial" name="role[]">
            <label class="">Financial</label></li>

            <li><input type="checkbox" class="checkorg" value="Document_Checker" name="role[]">
            <label class="">Document Checker</label></li>

            <li><input type="checkbox" class="checkorg" value="Common" name="role[]">
            <label class="">Common </label></li>

            <li><input type="checkbox" class="checkorg" value="one time" name="role[]">
            <label class="">One time</label></li>

            <li><input type="checkbox" class="checkorg" value="rfp_extractor" name="role[]">
            <label class="">RFP Extractor</label></li>

             <li><input type="checkbox" class="checkorg" value="document_approver" name="role[]">
  ...
  <div class="form-group">
           ...
           <button type="submit" id="send_form" class="btn btn-success" >Add User</button>
