   ...
   <div class="col-md-12 grid-margin stretch-card">
       <div class="card ">
           <div class="card-body rounded">
                ...
                <h4 class="mb-3">Document Uploader and Checker</h4>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <form class="p-0" action="<?php echo base_url('UserDashboardController/document_filter'); ?>" method="post">
                                                            <div class="mb-3">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="<?php echo base_url('/admin/document_data/'.$user['tender_id']);?>" class="btn btn-sm btn-outline-primary" >Add document </i></a>

                                                        <a href="<?php echo base_url('/admin/documents-approver/'.$user['tender_id']);?>" class="btn btn-sm btn-outline-primary" >Document Checker</i></a>
