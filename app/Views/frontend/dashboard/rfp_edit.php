          ...
          <div class="col-12 col-offset-2">
            <div class="card mt-3">
              <div class="card-body step p-0">
                <form method="post" id="update_tender" name="update_tender" action="<?= site_url('/UserDashboardController/rfp_document_update') ?>">
                  ...
                  <div class="row">
                    ...
                    <table class="table table-bordered table-bordered" id="dynamic_field">
                      <tr>
                        ...
                        <td><h6>Documents</h6><a href="<?php echo base_url().'/uploads/tender_document/'.$doc['document_file']; ?>" download>Download Document</a></td>
                        <td>
                            <a href="<?php echo base_url('UserDashboardController/document_edit_delete/'.$doc['id']);?>" class="btn btn-danger btn-sm">Delete</a>
                        </td>
                      ...
                      <!-- <tr>
                                                    ...
                                                    <td><h6>Documents Name</h6><input autocomplete="off" class="form-control Modified-file" type="text" name="workitem_description[]" ></td>
