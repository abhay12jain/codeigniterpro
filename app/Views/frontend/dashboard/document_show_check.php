   ...
   <div class="col-md-12 grid-margin stretch-card">
       <div class="card ">
           <div class="card-body rounded">
                ...
                <h4 class="mb-3">Document Pending Approvals</h4>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <form class="p-0" action="<?php echo base_url('UserDashboardController/document_check_filter'); ?>" method="post">
                                                            <div class="mb-3">
                                    ...
                                    <!-- <form method="post" id="update_user" action="<?//= site_url('/UserDashboardController/document_ch_show') ?>"> -->
                                        ...
                                        <table class="table table-hover table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url('/UserDashboardController/document_checkrs/'.$user['tender_id']);?>" class="btn btn-sm btn-outline-primary" >Approve Document</i></a>

                                                       <a href="<?php echo base_url('/UserDashboardController/rfp_extractor/'.$user['tender_id']);?>" class="btn btn-sm btn-outline-primary">RFP Extractor</i></a>
